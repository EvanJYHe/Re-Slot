  ...
  activity: [
    {
      ...
      message: "Alex's appointment was cancelled; Re-Slot opened refill work.",
      customerId: "alex",
      customerName: "Alex",
    },
    {
...
describe("AgentPage", () => {
  it("renders real conversations in the locked list, ledger, and context structure", async () => {
    ...
    expect(within(context).getByText("Alex's appointment was cancelled; Re-Slot opened refill work.")).toBeInTheDocument();
