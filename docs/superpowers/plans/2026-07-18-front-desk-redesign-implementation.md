...
- [ ] **Step 1: Write the failing normalized-conversation test**
...
- [ ] **Step 3: Add the normalized types and recorder**
...
- [ ] **Step 4: Extend Mongo persistence and indexes**
...
- [ ] **Step 1: Write failing Telegram recording tests**
...
- [ ] **Step 3: Record Telegram turns at delivery boundaries**
...
- [ ] **Step 4: Write failing ElevenLabs transcript tests**
...
- [ ] **Step 5: Run ElevenLabs tests and verify RED**
...
- [ ] **Step 6: Parse and persist voice activity**
...
- [ ] **Step 7: Run provider and webhook regression tests**
...
- [ ] **Step 8: Commit real activity capture**
...
- [ ] **Step 1: Write failing seed-density tests**
...
- [ ] **Step 3: Add deterministic week data**
...
- [ ] **Step 4: Verify ranking and reset identity preservation**
...
- [ ] **Step 5: Commit the realistic seed**
...
- [ ] **Step 3: Implement pure safe read models**
...
- [ ] **Step 6: Implement operator authentication and routes**
...
- [ ] **Step 7: Extend the typed browser client**
...
- [ ] **Step 8: Run API/type regressions**
...
- [ ] **Step 3: Configure REVIVE Tailwind tokens**
...
- [ ] **Step 5: Build the semantic shell in Tailwind utilities**
...
- [ ] **Step 7: Commit the Tailwind foundation**
...
- [ ] **Step 5: Run calendar tests and verify RED**
...
- [ ] **Step 6: Build the Tailwind calendar**
...
- [ ] **Step 7: Add safe manual appointment operations**
...
- [ ] **Step 8: Run calendar and regression tests**
...
- [ ] **Step 3: Build the locked three-column Agent page**
...
- [ ] **Step 4: Write failing Customers tests**
...
- [ ] **Step 7: Write failing Settings tests**
...
- [ ] **Step 9: Build the focused Settings page**
...
- [ ] **Step 10: Run all web tests and commit**
...
- [ ] **Step 2: Start the production-shaped local runtime**
...
- [ ] **Step 3: Perform local Chrome QA with browser-harness**
...
- [ ] **Step 4: Exercise the deterministic golden path**
...
- [ ] **Step 5: Deploy the branch to Railway**
