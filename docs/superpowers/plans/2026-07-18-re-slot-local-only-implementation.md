...
- [x] **Step 3: Write failing config tests for the retired admin settings**
...
- [x] **Step 5: Implement the minimal server simplification**
...
- [x] **Step 6: Verify the focused server suite is GREEN**
...
- [x] **Step 7: Commit only the local-only server hunks**
...
- [x] **Step 3: Write failing tokenless API tests**
...
- [x] **Step 6: Run the complete web suite and verify GREEN**
...
- [x] **Step 7: Commit the browser simplification**
...
- [x] **Step 1: Add local runtime scripts and ports**
...
- [x] **Step 2: Retire hosted configuration**
...
- [x] **Step 3: Mechanically sanitize the untracked local `.env`**
...
- [x] **Step 4: Verify local configuration**
...
- [x] **Step 5: Commit tracked local-runtime changes**
...
- [x] **Step 2: Delete the Railway project**
...
- [x] **Step 3: Unlink the local repository**
...
- [x] **Step 4: Final repository audit**
...
- [x] **Step 5: Complete the execution record**
